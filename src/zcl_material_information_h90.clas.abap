CLASS zcl_material_information_h90 DEFINITION
 PUBLIC
 FINAL
 CREATE PUBLIC .
 PUBLIC SECTION.
...
CLASS zcl_material_information_h90 IMPLEMENTATION.
...
zcl_material_information_h90.
 material_info = NEW zcl_material_information_h90( ).
